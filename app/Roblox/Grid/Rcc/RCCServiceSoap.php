...
class RCCServiceSoap {
	...
	private $SoapClient;
	private $classmap = [
		"Status" => "App\Roblox\Grid\Rcc\Status",
		"Job" => "App\Roblox\Grid\Rcc\Job",
		"ScriptExecution" => "App\Roblox\Grid\Rcc\ScriptExecution",
		"LuaValue" => "App\Roblox\Grid\Rcc\LuaValue",
		"LuaType" => "App\Roblox\Grid\Rcc\LuaType"
	];
	public $ip;
	public $port;
	public $url;
	...
	function __construct($url = "127.0.0.1", $port = 64989) {
		...
		$this->port = $port;
		$this->url = $url.$port;
		$this->SoapClient = new \SoapClient(__DIR__."\RCCService.wsdl", ["location" => "http://".$url.":".$port, "uri" => "http://noname.xyz/", "classmap" => $this->classmap, "exceptions" => false]);
	}
	...
	/**
	 * Name: Open Job
	 * Description: This function opens a job in accordance with the given arguments. Though this function is deprecated on App\Roblox's end, we'll still use it here and OpenJobEx will be called instead.
	 * Parameters: [
	...
	/**
	 * Name: Batch Job
	 * Description: This function runs a batch job in accordance with the given arguments. Though this function is deprecated on App\Roblox's end, we'll still use it here and BatchJobEx will be called instead.
	 * Parameters: [
	 *	"job" 	 => "The Job class that's going to be serialized and pushed to the service.",
	 *	"script" =>	"The ScriptExecution class that's going to be executed in the job. This contains values such as name, script, and arguments."
	 * ]
	...
	/**
	 * Name: Execute
	 * Description: This function uses the given arguments to execute a script inside an existing job. Though this function is deprecated on App\Roblox's end, we'll still use it here and ExecuteEx will be called instead.
	 * Parameters: [
	...
	/**
	 * Name: Diag
	 * Description: This function returns various types of diagnostic information from RCCService. Though this function is deprecated on App\Roblox's end, we'll still use it here and DiagEx will be called instead.
	 * Parameters: [
	...
	*/
	...
	/**
	 * Name: Get All Jobs
	 * Description: This function fetches an array of every job that's currently open on RCCService. Though this function is deprecated on App\Roblox's end, we'll still use it here and GetAllJobsEx will be called instead.
	 * Parameters: []
	 */
	function GetAllJobs() {
